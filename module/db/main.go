...
import (
	...
	"log"
	configWeb "xj_web_server/config"
	"xj_web_server/module/db/db"
	"xj_web_server/module/db/handler"
...
func main() {
	...
	service := micro.NewService(
		micro.Name("xj_web_server.service.db"),
	...
	err = proto.RegisterLoginDBGRPCServiceHandler(service.Server(), new(handler.LoginDBGRPCService))
	if err != nil {
		log.Fatalf("微服务注册失败:%v", err)
	}
